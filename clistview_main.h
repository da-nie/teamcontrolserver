...
class CListView_Main:public CListView
{
 ...
 protected:
  ...
  bool GetSelectedUser(SUser &sUser);//получить итератор выбранного пользовател€ из класса документа
  void SetSelectedUser(const SUser &sUser);//записать выбранного пользовател€ в класс документа
  //-ѕрочее------------------------------------------------------------------
